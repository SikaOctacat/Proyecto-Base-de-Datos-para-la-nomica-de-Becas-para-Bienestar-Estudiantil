...
1. **Cliente**: [main.js](file:///c:/xampp/htdocs/SI 14-4-26/main.js) bloquea el salto de pasos si no se han completado los anteriores (ej: ingresar la cédula con dígitos insuficientes, o un número telefónico con los dígitos erróneos).
